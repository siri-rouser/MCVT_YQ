...
def detect(save_img=False):
    ...
    # Directories
    opt.project = '/home/yuqiang/yl4300/project/MCVT_YQ/datasets/algorithm_results/detect_merge_test/'
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    line = f"{det_class} {x_center} {y_center} {width} {height} {det_conf}\n"
...
if __name__ == '__main__':
    ...
    cfg.freeze()
    opt.source = f'{cfg.DET_SOURCE_DIR}/{opt.name}/img_test/'
