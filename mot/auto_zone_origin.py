...
def main(seq):
    ...
    mean_shift_result = mean_shifter.cluster(data, kernel_bandwidth = 80)
    ...
    # bbox_mean_shift_result0 = mean_shifter.cluster(bbox_data0, kernel_bandwidth = 100)
    ...
    # bbox_mean_shift_result1 = mean_shifter.cluster(bbox_data1, kernel_bandwidth = 100)
