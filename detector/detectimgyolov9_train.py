...
for seq in seqs:
    ...
    source = f'/home/yuqiang/yl4300/project/MCVT_YQ/datasets/algorithm_results_train/detection/images/train/S01/{seq}/img1/'
    ##############################################

    # Directories
    # save_dir = Path(increment_path(Path(opt.project) / opt.name, exist_ok=opt.exist_ok))  # increment run
    save_txt = True
    save_dir = Path(Path('/home/yuqiang/yl4300/project/MCVT_YQ/datasets/algorithm_results_train/detect_merge') / Path(seq))
