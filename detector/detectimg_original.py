        ...
        for i, result in enumerate(result):  # detections per image
            ...
            if len(result): # if any vehicle is been detected here
                ...
                for res in result:
                    ...
                    # Write to file
                    if save_txt:
                        with open(txt_path_data + '.txt', 'a') as f: # a means append, what f.write in here will be appended into the end of the file
                            f.write(('%g ' * len(line_data)).rstrip() % tuple(line_data) + '\n')    
