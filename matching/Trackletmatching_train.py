...
from util_tools_train import calc_reid,update_output,reid_cat,reid_dict_filter,xytoxywh
import sys
sys.path.append('../')
...
def main(previous_reid_dict,previous_rm_dict,query_cam,gallery_cam,abs_path):
    H = {}
...
if __name__ == "__main__":
    ...
    # abs_path = '/home/yuqiang/yl4300/project/MCVT_YQ/datasets/algorithm_results_train/detect_merge'
  ...
  #  seqs = ['c041']
    for i in range(len(seqs)-1):
        ...
        reid_dict, rm_dict = main(reid_dict,rm_dict,seqs[i],seqs[i+1],abs_path)
