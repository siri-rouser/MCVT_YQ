...
# Speed_limit in here means the time difference after considering the time-spatioal constrains 
SPEED_LIMIT = [[(0,0),(-34,66),(-30,70),(-29,71),(-28,72)],
               [(-66,34),(0,0),(-46,54),(-45,55),(-44,56)],
               [(-70,30),(-54,46),(0,0),(-49,51),(-48,52)],
               [(-71,29),(-55,45),(-51,49),(0,0),(-49,51)],
               [(-72,28),(-56,44),(-52,48),(-51,49),(0,0)]]

def calc_reid(dismat,q_track_ids,q_cam_ids, g_track_ids, g_cam_ids, q_times, g_times, new_id, dis_thre=0.295,dis_remove=0.35):
    ...
    for index, q_track_id in enumerate(q_track_ids):
        ...
        speed_limit_min = np.array([SPEED_LIMIT[q_cam_id-1][g_cam_id-1][0]/10 for g_cam_id in g_cam_ids[order]])
        speed_limit_max = np.array([SPEED_LIMIT[q_cam_id-1][g_cam_id-1][1]/10 for g_cam_id in g_cam_ids[order]])
